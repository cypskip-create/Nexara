...
export const faqs = [
  ...
  ['Can I automate follow-ups?', 'Live workspaces can persist score-based workflows, create tasks, update stages or notify owners. Every run is recorded as successful, skipped or failed for review.'],
