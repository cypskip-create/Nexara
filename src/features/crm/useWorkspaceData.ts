...
const seedLeads: WorkspaceLead[] = [
  { id:'lead-james', name:'James Mwangi', email:'james@example.com', phone:'+254 712 345 678', company:'Individual buyer', interest:'3-bedroom apartment · Kilimani', source:'Website', stage:'Qualified', score:86, value:'KSh 18–22M', owner:'Cyprian', ownerId:'Cyprian', tags:['High intent','Kilimani'], createdAt:'2026-09-22T07:30:00.000Z', lastActivity:'2 min ago', nextAction:'Arrange a viewing', notes:[{id:'event-james',kind:'created',text:'Lead created from website conversation',at:'2026-09-22T07:30:00.000Z'}] },
  { id:'lead-aisha', name:'Aisha Njeri', email:'aisha@example.com', phone:'+254 722 456 789', company:'Njeri Holdings', interest:'Townhouse · Lavington', source:'WhatsApp', stage:'Contacted', score:72, value:'KSh 28M', owner:'Cyprian', ownerId:'Cyprian', tags:['Townhouse'], createdAt:'2026-09-21T09:10:00.000Z', lastActivity:'1 hour ago', nextAction:'Confirm Saturday viewing', notes:[{id:'event-aisha',kind:'created',text:'Lead created from WhatsApp enquiry',at:'2026-09-21T09:10:00.000Z'}] },
