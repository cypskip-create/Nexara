...
import type { ContactDraft, LeadDraft, LeadStage, TimelineEntry, WorkspaceContact, WorkspaceLead } from './types'
...
export function useWorkspaceData() {
  ...
  return {leads:activeLeads,archivedLeads:data.leads.filter(lead=>lead.archived),contacts:data.contacts,addLead,updateLead,moveLead,addNote,archiveLeads,addContact,updateContact,resetDemo}
}
